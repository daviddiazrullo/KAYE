...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TEXTO QUE SE MUESTRA EN EL BOTON
        btnToggle3.setTextOn("APAGAR");
        btnToggle3.setTextOff("ENCENDER");
        ...
        sacarValorBDLuces(refLed1,btnToggle);
        controlLED(refLed1, btnToggle);

        sacarValorBDLuces(refled2,btnToggle2);
        controlLED(refled2, btnToggle2);
    ...
    private void sacarValorBDLuces(final DatabaseReference refLed, final ToggleButton toggle_btn ){
        ...
        refLed.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                textEstadoPulsador.setText(Dato2);
            }
    ...
    // Con este metodo controlo el cambio del boton para que me cambie el valor en la base de datos
